...
The Jupyter notebooks [SurfaceQ demo 1](./src/SurfaceQ demo 1.ipynb) and [SurfaceQ demo 2](./src/SurfaceQ demo 2.ipynb) demonstrate some of the functionality of the SurfaceQ package. 